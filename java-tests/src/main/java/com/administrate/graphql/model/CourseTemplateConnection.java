...
public class CourseTemplateConnection {
    private List<CourseTemplateEdge> edges;
    private PageInfo pageInfo;

    public List<CourseTemplateEdge> getEdges() { return edges; }
    public void setEdges(List<CourseTemplateEdge> edges) { this.edges = edges; }

    public PageInfo getPageInfo() { return pageInfo; }
    public void setPageInfo(PageInfo pageInfo) { this.pageInfo = pageInfo; }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static class CourseTemplateEdge {
        private String cursor;
        private CourseTemplate node;

        public String getCursor() { return cursor; }
        public void setCursor(String cursor) { this.cursor = cursor; }

        public CourseTemplate getNode() { return node; }
        public void setNode(CourseTemplate node) { this.node = node; }
    }
